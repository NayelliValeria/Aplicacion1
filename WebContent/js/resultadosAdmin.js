...
/*        if ( $(this).hasClass('row_selected') ) {
	...
	$('#agregar').click(function(){
		...
		if( 
			...
			$.ajax({
				url:'/Aplicacion1/AgregarCandidato',
				type: 'POST',
				data: 
					'nombre=' + $("#nombre").val() +
					'&materno='+ $("#materno").val() +
	...
	$('#siQuieroEliminar').click( function() {
		...
		{
			$.ajax({
				url:'/Aplicacion1/EliminarCandidato',
				type: 'POST',
	...
	{
		$.ajax({
			url:'/Aplicacion1/AgregarTecnologia',
			type:'POST',
			async: false,
	...
	{
		$.ajax({
			url:'/Aplicacion1/EditarCandidato',
			type:'POST',
			data:'idCandidato=' + idCandidato +
			'&nombre=' + $("#nombre").val() +
